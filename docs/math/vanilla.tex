...
\begin{equation}
	...
	\Psi = \nu\lambda .
\end{equation}
All $k \times k$ matrices become scalars, and the dictionary between the two
chapters is:
\begin{center}
	\begin{tabular}{lll}
		\toprule
	...
	\end{tabular}
\end{center}
All tree-prior and proposal-kernel factors are unchanged.
...
\eqref{eq:mv-nonlk-grow} verbatim:
\begin{equation}
	\label{eq:nonlk-grow}
